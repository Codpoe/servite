import{u as a,j as n,a as l,F as d}from"./index-afe46c0f.js";const o=void 0,h=[{id:"1-快速搭建项目",text:"1. 快速搭建项目",depth:2},{id:"2-启动本地开发服务器",text:"2. 启动本地开发服务器",depth:2},{id:"3-构建生产环境产物",text:"3. 构建生产环境产物",depth:2},{id:"4-本地预览",text:"4. 本地预览",depth:2}];function s(c){const e=Object.assign({h1:"h1",a:"a",p:"p",code:"code",h2:"h2",pre:"pre",span:"span"},a(),c.components),{Callout:r}=e;return r||i("Callout",!0),l(d,{children:[l(e.h1,{id:"开始上手",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",tabIndex:"-1",href:"#开始上手",children:"#"}),"开始上手"]}),`
