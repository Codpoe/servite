import{u as r,j as e}from"./index-BDl0G4IS.js";const i={commitTime:1712489739},c=[{id:"介绍",text:"介绍",depth:2},{id:"使用",text:"使用",depth:2},{id:"开启-ssg-和-islands",text:"开启 SSG 和 islands",depth:3},{id:"标记孤岛",text:"标记孤岛",depth:3},{id:"孤岛水合时机",text:"孤岛水合时机",depth:3}];function d(n){const s={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.h1,{id:"islands---孤岛架构",children:[e.jsx(s.a,{className:"header-anchor","aria-hidden":"true",tabIndex:"-1",href:"#islands---孤岛架构",children:"#"}),"islands - 孤岛架构"]}),`
